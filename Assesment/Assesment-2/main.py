...
tkinter.Button(text="1.Check-Inn",font="Monospace 16",command=ckn).place(x=180,y=50)
...
tkinter.Button(text="5.exit",font="Monospace 16 ",command=window.destroy).place(x=180,y=250)
